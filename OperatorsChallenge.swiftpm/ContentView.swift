        ...
        VStack(alignment: .leading) {
            ...
            Button("Test MVP") {
                ...
                if number1 != "" && number2 != "" {
                    ...
                    let notEqualTo: Bool = number1 != number2
                    let greaterThan: Bool = number1 > number2
                    let lessThan: Bool = number1 < number2
                    let greaterThanOrEqualTo: Bool = number1 >= number2
                    let lessThanOrEqualTo: Bool = number1 <= number2
